...
const features = [
  {
    ...
    description: "O modelo identifica automaticamente a categoria de cada conteúdo — Backend, Frontend, Dados, DevOps — com a probabilidade de acerto.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Extração de palavras-chave",
    description: "Técnicas de TF-IDF e processamento de texto identificam os termos mais relevantes de cada material técnico.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Busca semântica e agrupamento",
    description: "Encontre conteúdos por tema ou tópico e agrupe materiais semelhantes usando similaridade textual.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Recomendação relacionada",
    description: "A partir de um conteúdo, o TechMind sugere materiais relacionados para construir uma base de conhecimento reutilizável.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const cx = Math.round((100 + Math.cos(angle) * radius) * 100) / 100;
        const cy = Math.round((80 + Math.sin(angle) * radius) * 100) / 100;
        return (
          <g key={i}>
            {/* Connection line */}
            <line
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Ciência de Dados
            <br />
            <span className="text-muted-foreground">a serviço do conhecimento.</span>
          </h2>
        </div>
